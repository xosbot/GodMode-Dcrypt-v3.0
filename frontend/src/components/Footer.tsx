      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-blue-400 mb-4">CrypDo</h3>
            <p className="text-gray-300 mb-4 max-w-md">
              The leading DeFi yield farming platform, helping investors maximize their crypto returns through advanced strategies and cutting-edge technology.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Yield Farming</a></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 CrypDo. All rights reserved.
          </p>
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-500">
            🔒 Secured by industry-leading encryption | 🛡️ Audited by Certik | ⚡ Powered by Ethereum
          </p>
        </div>
      </div>
    </footer>
